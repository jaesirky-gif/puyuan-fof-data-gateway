...
from .view import IndexPointAPI, IndexMonthlyRetAPI, IndexDrawDownWaterAPI, IndexPeriodRetAPI, \
    IndexPeriodRatiosAPI, IndexPEAPI, IndexPointQueryAPI, IndexSearcherAPI
...
api.add_resource(IndexPointQueryAPI, '/point_query')
...
api.add_resource(IndexPEAPI, '/pe/<string:index_id>')
